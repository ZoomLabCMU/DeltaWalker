...
void reset()
{
  ...
  {
    if (motors[i] != NULL) {
      desired_joint_positions[i] = 10.0; //------------------------------------------------------------------------------------------
    }
  }
  // desired_joint_positions[2] = 10.0;
  // desired_joint_positions[0] = 10.0;

  // desired_joint_positions[5] = 1.0;
  // desired_joint_positions[3] = 1.0;

  // desired_joint_positions[6] = 1.0;
  // desired_joint_positions[7] = 1.0;

  // desired_joint_positions[9] = 10.0;
  // desired_joint_positions[10] = 10.0;
}
